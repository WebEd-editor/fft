...
async function loadForm(){
  loader.show();
  try {
    const res = await fetch(`https://fft-registration-kotu.onrender.com/api/tournament/${tournamentId}`);
...
async function registerTournament(d) {
    ...
    const res = await fetch("https://fft-user-1-872i.onrender.com/api/user/register", {
        method: "POST",
        headers: {
...
async function formValidation(d){
   const res = await fetch("https://fft-registration-kotu.onrender.com/api/user/register/validation", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
...
async function registerTeam(d) {
    ...
    const res = await fetch("https://fft-registration-kotu.onrender.com/api/user/register", {
        method: "POST",
        headers: {
            "Content-Type": "application/json"
        },
